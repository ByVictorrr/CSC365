    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while((line = reader.readLine()) != null) {
                ...
                students.add(new Student(fields.get(0), fields.get(1), Integer.parseInt(fields.get(2)),Integer.parseInt(fields.get(3)),
                                        Integer.parseInt(fields.get(4)), Float.parseFloat(fields.get(5)), fields.get(6), fields.get(7)));
            }
            reader.close();
        }catch(Exception e) {
        ...
        while(isRunning){
            ...
            command_list = Arrays.asList(command.split(" "));
            switch(command.charAt(0)){
                ...
                case 'I':
                    ...
                    break;
                case 'Q':
                    if(command_list.get(0).equals("Quit") | command_list.get(0).equals("Q"))
                        isRunning=false;
                    break;
                default:
